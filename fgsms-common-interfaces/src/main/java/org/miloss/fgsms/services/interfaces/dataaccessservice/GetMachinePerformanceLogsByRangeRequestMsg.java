 ...
 * request message
 * 
 * <p>Java class for GetMachinePerformanceLogsByRangeRequestMsg complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetMachinePerformanceLogsByRangeRequestMsg">
 *   &lt;complexContent>
...
@XmlType(name = "GetMachinePerformanceLogsByRangeRequestMsg", propOrder = {
    "classification",
    "uri",
    "range",
    "recordcount",
...
public class GetMachinePerformanceLogsByRangeRequestMsg
