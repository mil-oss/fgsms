...
public class RemoteAgentCallbackService
    extends Service
{

    private final static URL REMOTEAGENTCALLBACKSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.miloss.fgsms.services.interfaces.agentcallbackservice.RemoteAgentCallbackService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.miloss.fgsms.services.interfaces.agentcallbackservice.RemoteAgentCallbackService.class.getResource(".");
            url = new URL(baseUrl, "file:/C:/Projects/fgsms/xml/DotNetFriendly/RemoteAgentCallback.wsdl");
    ...
    public RemoteAgentCallbackService(URL wsdlLocation, QName serviceName) {
