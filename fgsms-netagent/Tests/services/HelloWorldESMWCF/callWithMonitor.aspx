<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="callWithMonitor.aspx.cs"
    Inherits="HelloWorldESMTester.callWithMonitor" %>
...
<body>
    <%
      ...
      b.Security.Transport.ClientCredentialType = System.ServiceModel.HttpClientCredentialType.Basic;
        org.miloss.fgsms.MessageProcessor mp = org.miloss.fgsms..MessageProcessor.Instance;
      factory.Endpoint.Behaviors.Add(new org.miloss.fgsms.wcf.AgentWCFClientEndpointBehavior());
      ...
      try
      {
       ...
       //   Response.Status = "OK";
          s += "|" + org.miloss.fgsms.MessageProcessor.GetQueueSize();
          s += "|" + org.miloss.fgsms.MessageProcessor.GetPolicyCacheSize();
          s += "|" + org.miloss.fgsms.MessageProcessor.LastErrorMessage;
      }
      catch (Exception ex)
      {
          s = "ERROR ";
