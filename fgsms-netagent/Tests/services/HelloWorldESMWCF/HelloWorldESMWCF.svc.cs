...
namespace HelloWorldESMTester
{
    ...
    public class Service1 : IService1
    {
        ...
        } // end RandomWorkingMethod

        #endregion

        #region IService1 Members

        public string CallDependantService(int value)
        {
            asmxHelloWorld.Service1 svc = new HelloWorldESMTester.asmxHelloWorld.Service1();
