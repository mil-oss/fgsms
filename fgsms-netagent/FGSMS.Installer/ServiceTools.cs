...
{
    /// <summary>
    /// Source: provides some basic functions for installing, stopping and uninstalling windows services programmatically
    /// there's no known license associated with this code 
