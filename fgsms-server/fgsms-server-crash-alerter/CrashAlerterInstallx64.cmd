...
set SERVICE_JAVA=fgsmsServerCrash
...
--Classpath="%PATH_JAR%fgsms-sca-jar-with-dependencies.jar" ^
 --StartMode=jvm --StartClass=org.miloss.fgsms.alerting.Daemon --StartMethod start ^
 --StopMode=jvm  --StopClass=org.miloss.fgsms.alerting.Daemon  --StopMethod stop ^
 --Description="fgsms Server Crash Alerter"  
 
rem  --StartParams=start ^
echo Installation of %SERVICE_JAVA% is complete, starting....
net start %SERVICE_JAVA%
echo Finished
