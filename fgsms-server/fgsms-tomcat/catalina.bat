...
rem
set CATALINA_OPTS=%CATALINA_OPTS% -Djavax.xml.parsers.DocumentBuilderFactory=com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderFactoryImpl -Djavax.xml.parsers.SAXParserFactory=com.sun.org.apache.xerces.internal.jaxp.SAXParserFactoryImpl -Dorg.miloss.fgsms.agentConfigFileOverride=fgsms-agent.properties -Xmx1024m -XX:MaxPermSize=256m  -XX:+HeapDumpOnOutOfMemoryError -Djavax.net.ssl.keyStore=C:\projects\fgsms\fgsms-server\fgsms-tomcat\target\tomcat\apache-tomcat-7.0.75\conf\keystore.jks -Djavax.net.ssl.keyStorePassword=changeit -Djavax.net.ssl.trustStore=C:\projects\fgsms\fgsms-server\fgsms-tomcat\target\tomcat\apache-tomcat-7.0.75\conf\truststore.jks -Djavax.net.ssl.trustStorePassword=changeit
