 ...
 * @author AO
 */
public class SMXJMXStarter implements ServletContextListener {

    public static final String JOB_NAME = "SMX JMX";
    public static final String TRIGGER_NAME = "SMX JMX Trigger";
    ...
    protected static void StartupCheck() {
        try {
            ...
            if (!AuxConstants.QuartzJobExists(JOB_NAME, sc)) {
                job = new JobDetail(JOB_NAME, AuxConstants.QUARTZ_GROUP_NAME, org.miloss.fgsms.auxsrv.SMXJMXScheduler.class);
                ...
                try {
                    ...
                    log.log(Level.WARN, "the configuration parameter for smx via jmx interval is " + intinterval + " and could not be parsed as an integer. Defaulting to 30 second pings");
                ...
                log.log(Level.INFO, "SMX JMX added at interval " + intinterval + "ms");
            ...
            log.log(Level.WARN, "error scheduling smx agent", ex);
        }
    }
    ...
    public void contextDestroyed(ServletContextEvent sce) {
         ...
         *
         *
         * sc.unscheduleJob("SMX JMX", "fgsms Aux Services ");
         * sc.deleteJob("SMX JMX", "fgsms Aux Services ");
         *
         *
