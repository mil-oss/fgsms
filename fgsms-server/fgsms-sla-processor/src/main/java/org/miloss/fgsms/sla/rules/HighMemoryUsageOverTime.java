...
public class HighMemoryUsageOverTime implements SLARuleInterface {
    ...
    public String GetHtmlFormattedHelp() {
        return "This rule will trigger when the Memory utilization rate is greater than the specified value for the specified duration."
                ...
                + "This rule applies to both Machine and Process policies.<br><br>"
                + "Required parameters:"
                + "<ul>"
