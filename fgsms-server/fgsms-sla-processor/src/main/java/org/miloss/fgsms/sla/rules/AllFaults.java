...
public class AllFaults implements SLARuleInterface {
    ...
    public boolean CheckTransactionalRule(AddDataRequestMsg req, List<NameValuePair> params, AtomicReference<String> nullableFaultMsg) {
        ...
        if (!req.isSuccess()) {
            nullableFaultMsg.set("All faults, " + nullableFaultMsg.get());
            return true;
        }
        return false;
    }
    ...
    public String GetDisplayName() {
        return "All Faulting Transactions";
    }
    
    @Override
    public String GetHtmlFormattedHelp() {
        return "This rule triggers on all faulting messages and applies only to transactional services. No parameters are required.<br>"
