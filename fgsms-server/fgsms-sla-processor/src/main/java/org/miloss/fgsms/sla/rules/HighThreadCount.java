...
public class HighThreadCount implements SLARuleInterface {
    ...
    public String GetHtmlFormattedHelp() {
        return "This rule will trigger when a process or machine has a high number of threads running. This applies to machine and process service policies only.<br><br>"
                + "Required Parameters:"
                + "<ul>"
                + "<li>value - some positive integer value representing the threshold such as if the thread count is greater than the value, the rule is triggered.</li>"
                + "</ul>";
