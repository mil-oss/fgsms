...
public class MeanTimeBetweenFailureGreatThan implements SLARuleInterface {
    ...
    public boolean CheckNonTransactionalRule(ServicePolicy pol, List<NameValuePair> params, AtomicReference<String> nullableFaultMsg, boolean pooled) {
        ...
        if (faultrate > duration) {
            nullableFaultMsg.set("MTBF measured value of " + faultrate + " is greater than " + rate + ", " + nullableFaultMsg.get());
            return true;
        }
        return false;
    }
    ...
    public String GetDisplayName() {
        return "MTBF greater than (value)";
    }

    @Override
    public String GetHtmlFormattedHelp() {
        return "This rule will trigger when the Mean Time Between Failure is greater than the specified duration."
                ...
                + "<li>duration - must be a positive integer or long. This represents time in milliseconds for the duration to search through. It must be one of the values from which"
