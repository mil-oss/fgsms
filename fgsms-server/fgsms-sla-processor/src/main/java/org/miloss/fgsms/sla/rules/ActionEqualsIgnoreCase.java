...
public class ActionEqualsIgnoreCase implements SLARuleInterface {
    ...
    public boolean CheckTransactionalRule(AddDataRequestMsg req, List<NameValuePair> params, AtomicReference<String> nullableFaultMsg) {
        ...
        if (req.getAction().equalsIgnoreCase(item)) {
            nullableFaultMsg.set("Action Equals Ignore Case " + item + ", " + nullableFaultMsg.get());
        }
        return false;
    }
    ...
    public String GetDisplayName() {
        return "Action or Method equals (value), case insensitive";
    }

    @Override
    public String GetHtmlFormattedHelp() {
        return "If the SOAP Action or Method equals (value), case insensitive, then this rule will trigger.<Br>"
