...
public class ResponseTimeGreaterThan  implements SLARuleInterface {
    ...
    public boolean CheckTransactionalRule(AddDataRequestMsg req, List<NameValuePair> params, AtomicReference<String> nullableFaultMsg) {
        ...
        if (req.getResponseTime() > val) {
            nullableFaultMsg.set("The response time size, " + req.getResponseTime() + ", is greater that the value " + val + ", "+ nullableFaultMsg.get());
        }
        return false;
    }
    ...
    public String GetDisplayName() {
        return "Response time is greater than value";
    }

    @Override
    public String GetHtmlFormattedHelp() {
        return "If a transaction's response time is greater than the specified value, then this rule will trigger.<Br>"
