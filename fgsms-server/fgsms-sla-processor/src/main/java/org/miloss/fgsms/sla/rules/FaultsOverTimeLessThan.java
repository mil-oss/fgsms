...
public class FaultsOverTimeLessThan implements SLARuleInterface {
    ...
    public boolean CheckNonTransactionalRule(ServicePolicy pol, List<NameValuePair> params, AtomicReference<String> nullableFaultMsg, boolean pooled) {
        ...
        if (faultrate < rate) {
            nullableFaultMsg.set("Faults Over Time measured value of " + faultrate + " is less than " + rate + ", " + nullableFaultMsg.get());
            return true;
        }
        return false;
    }
    ...
    public String GetDisplayName() {
        return "Faults over time is less than (value)";
    }

    @Override
    public String GetHtmlFormattedHelp() {
        return "This rule will trigger when the number of faulty transactions over time is less than the specified value for the specified duration."
