                ...
                if (res.get(i) != null) {
                    ...
                    if (res.get(i).getType() != null) {
                        ...
                        if (res.get(i).getType() == AlertType.MESSAGE_FAULT) {
                            out.write("Message Fault <a href=\"javascript:loadpage('reporting/SpecificTransactionLogViewer.jsp?ID=" + URLEncoder.encode(res.get(i).getTransactionid()) + "','mainpane');\">View Transaction</a>");
                        }
                        if (res.get(i).getType() == AlertType.SLA_FAULT) {
                            if (Utility.stringIsNullOrEmpty(res.get(i).getTransactionid())) {
                                out.write("SLA Fault <a href=\"javascript:loadpage('profile/slarecords.jsp?url=" + URLEncoder.encode(res.get(i).getUrl()) + "','mainpane');\">View This Record</a>");
                            } else {
                                out.write("SLA Fault <a href=\"javascript:loadpage('reporting/SpecificTransactionLogViewer.jsp?ID=" + URLEncoder.encode(res.get(i).getTransactionid()) + "','mainpane');\">View This Transaction</a>");
                            }
                        }
                    }
                    out.write("<br>");
