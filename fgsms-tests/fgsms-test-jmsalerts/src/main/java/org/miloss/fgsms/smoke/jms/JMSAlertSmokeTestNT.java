 ...
 * @author AO
 */
public class JMSAlertSmokeTestNT {
     ...
     private static void SetPolicy() throws ConfigurationException, ServiceUnavailableException, AccessDeniedException, DatatypeConfigurationException {
          ...
          r.setClassName("org.miloss.fgsms.sla.rules.FaultsOverTimeGreaterThan");
          r.getParameterNameValue().add(Utility.newNameValuePair("duration", "300000", false, false));
          r.getParameterNameValue().add(Utility.newNameValuePair("value", "1", false, false));
