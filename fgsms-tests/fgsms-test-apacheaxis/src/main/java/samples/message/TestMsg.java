...
public class TestMsg {
    public String doit(String[] args) throws Exception {
        ...
        opts.setDefaultURL("http://localhost:8888/fgsmsApacheAxis/services/MessageService");
    ...
    public void testEnvelope(String[] args) throws Exception {
        ...
        SOAPMessage response = conn.call(smsg, "http://localhost:8888/fgsmsApacheAxis/services/MessageService");
    }
