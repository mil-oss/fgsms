 ...
 * @author AO
 */
public class TC00162_JAXWS_CXFTest {
    ...
    static String firsthop_url = "http://" + Utility.getHostName() + ":9162/Service1";
    static String jettyurl = "http://localhost:9162/Service1";
