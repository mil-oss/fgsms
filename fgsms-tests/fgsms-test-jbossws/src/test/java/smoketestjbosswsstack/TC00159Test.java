...
/**
 *TC00159 JAXWS Monitored Client to JAXWS Monitored Service, self hosted using JDK soap stack (sun's)
 * @author AO
 */

public class TC00159Test  {
    ...
    /**
     * Test of main method, of class fgsmsSmokeTest.
     */
    //@org.junit.Test
   // public void testSmokeTestJMS() {
        /*
         * System.out.println("testSmokeTestJMS"); ProcessBuilder pb = new
         * ProcessBuilder("java -jar ../tests/"); try { Process p = pb.start();
         * p.waitFor(); if (p.exitValue() != 0) { fail("the test failed exit
         * code was " + p.exitValue()); } } catch (Exception ex) {
         * ex.printStackTrace(); fail("unexpected failure"); }
         */
 //   }
    ...
    /**
     * TC00159 JAXWS Monitored Client to JAXWS Monitored Service, self hosted using Jbossws soap stack
     * @throws Exception 
     */
    @org.junit.Test
    public void TC00159_1_MonitoredJaxWSClientToMonitorwsJaxWSServiceSelfHosted() throws Exception {
        TC00159_dowork(false, false);
    }

    @org.junit.Test
    public void TC00159_2_MonitoredJaxWSClientToMonitorwsJaxWSServiceSelfHosted() throws Exception {
        TC00159_dowork(true, false);
    }

    @org.junit.Test
    public void TC00159_3_MonitoredJaxWSClientToMonitorwsJaxWSServiceSelfHosted() throws Exception {
        TC00159_dowork(false, true);
    }

    @org.junit.Test
    public void TC00159_4_MonitoredJaxWSClientToMonitorwsJaxWSServiceSelfHosted() throws Exception {
        TC00159_dowork(true, true);
    }

    void TC00159_dowork(boolean request, boolean response) throws Exception {
    ...
    //http://fgsmsdev1:8180/TempUriService1/Service1Impl?wsdl
